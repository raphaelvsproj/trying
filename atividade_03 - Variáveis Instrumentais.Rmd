...
dicpess <- read.csv2(file = "E:/Documentos/R-Studio/Laboratório de Econometria/Atividade 3/Dicionarios e inputs/dicpess1.csv", header=F)
...
fwf2csv(fwffile='E:/Documentos/R-Studio/Laboratório de Econometria/Atividade 3/Dados/Dados_20170517/Dados/PES2015.txt', csvfile='dadospess.csv', names=dicpess$variavel, begin=dicpess$inicio, end=end_pess)
